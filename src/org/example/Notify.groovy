...
class Notify{
  def static String mailBody(CurrentBuild){
   ...
   def mailBody = "<html><table border='1' width='100%'>"
    ...
    mailBody += "<tr><td width='25%'><b>Project : </b></td><td width='75%'> JobName </td></tr>"
    mailBody += "<tr><td width='25%'><b>Build Number : </b></td><td width='75%'> BuildNumber </td></tr>"
    ...
    def haveChages = "No"
        ...
        def changeLogSets = CurrentBuild
